...
internal class Note {
    ...
    public static List<Note> GetNoteList() {
        ...
        notes.Add(new Note() { ID = 93, Desc = "F8" });
        ...
        notes.Add(new Note() { ID = 101, Desc = "C♯9/D♭9" });
        notes.Add(new Note() { ID = 102, Desc = "D9" });
        notes.Add(new Note() { ID = 103, Desc = "D♯9E♭9" });
        notes.Add(new Note() { ID = 104, Desc = "E9" });
        notes.Add(new Note() { ID = 105, Desc = "F9" });
        notes.Add(new Note() { ID = 106, Desc = "F♯9G♭9" });
        notes.Add(new Note() { ID = 107, Desc = "G9" });
        notes.Add(new Note() { ID = 108, Desc = "G♯9A♭9" });
        notes.Add(new Note() { ID = 109, Desc = "A10" });
        notes.Add(new Note() { ID = 110, Desc = "A♯10B♭10" });
        notes.Add(new Note() { ID = 111, Desc = "B10" });
        notes.Add(new Note() { ID = 112, Desc = "C10" });

        notes.Add(new Note() { ID = 113, Desc = "C♯10/D♭10" });
        notes.Add(new Note() { ID = 114, Desc = "D10" });
        notes.Add(new Note() { ID = 115, Desc = "D♯10E♭10" });
        notes.Add(new Note() { ID = 116, Desc = "E10" });
        notes.Add(new Note() { ID = 117, Desc = "F10" });
        notes.Add(new Note() { ID = 118, Desc = "F♯10G♭10" });
        notes.Add(new Note() { ID = 119, Desc = "G10" });
        notes.Add(new Note() { ID = 120, Desc = "G♯10A♭10" });
        notes.Add(new Note() { ID = 121, Desc = "A11" });
        notes.Add(new Note() { ID = 122, Desc = "A♯11B♭11" });
        notes.Add(new Note() { ID = 123, Desc = "B11" });
        notes.Add(new Note() { ID = 124, Desc = "C11" });
